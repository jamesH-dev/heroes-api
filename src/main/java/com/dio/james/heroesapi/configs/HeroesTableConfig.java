...
public class HeroesTableConfig {
    public static void main(String[] args) throws Exception {
        ...
        String tableName = "tab_heroes";

        try {
            Table table = dynamoDB.createTable(tableName,
                    Collections.singletonList(new KeySchemaElement("hero_id", KeyType.HASH)),
                    Collections.singletonList(new AttributeDefinition("hero_id", ScalarAttributeType.S)),
